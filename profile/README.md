...
2. **Declarative Interfaces**: Defined in **Baryon (Baryon Language)**, specifying generic inputs/outputs that can be transpiled into any frontend (R, Python, Bash, Galaxy, Nextflow, Streamflow).
...
* [**Tutorial\_Fairflow**](https://github.com/Fairflow-BioinformaticsFramework/Tutorial_Fairflow): **Start Here!** The canonical guide to the FairFlow path. It covers everything from building containers to writing `.bala` files.
* [**Tutorial\_CARNGS**](https://github.com/Fairflow-BioinformaticsFramework/Tutorial_CARNGS): Specific tutorials for the CAR-NGS suite of pipelines.
...
2. **Follow the Tutorial**: Go to [**Tutorial\_Fairflow**](https://github.com/Fairflow-BioinformaticsFramework/Tutorial_Fairflow) to build your first reproducible pipeline.
